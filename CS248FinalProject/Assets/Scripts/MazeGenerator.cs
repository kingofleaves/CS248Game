...
/*************************************************************************************
 * Disable the 'mazegen.cs' script from making blocks in your scene.                 *
 * use // in front of lines 10, 12, 51, 56, 57, 59, 60, 64.                          *
 * When this script runs it will now only generate the 'MazeString'.                 *
 * Because the Awake function calls MakeBlocks(), it is run before Start functions.  *
 * Check in the Console window that it is printing the string out.                   *
 *************************************************************************************/
